...
object SparkDataFrame{
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df = spark.read
      ...
      .load("C:/Users/srujan reddy/Desktop/survey.csv")

    //Save data to the ouput folder
    df.write.format("csv").option("header","true").save("C:/Users/srujan reddy/Desktop/output")
    ...
    val lines = sc.textFile("C:/Users/srujan reddy/Desktop/survey.csv")
