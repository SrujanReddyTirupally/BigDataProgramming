...
object Graphs {
  def main(args: Array[String]): Unit = {
    ...
    //Saving to File
    stationGraph.vertices.write.csv("C:\\Users\\srujan reddy\\Desktop\\output\\vertices.csv")
    stationGraph.edges.write.csv("C:\\Users\\srujan reddy\\Desktop\\output\\edges.csv")
  }
}